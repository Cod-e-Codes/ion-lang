...
- **Wadler** (1990): "Linear Types Can Change the World!"; linear logic to resource-safe imperative code (`tc`)
...
- **Sewell, Myreen & Klein** (PLDI 2013): translation validation C to binary (seL4). [PDF](https://www.trustworthy.systems/publications/nicta_full_text/6449.pdf) (`cgen`)
...
Ion takeaway: test-driven validation (integration + `cgen` grep) is the practical analog for this repo size; cite Cogent/Hofmann for move-only to C correctness *patterns*, not full Isabelle/Coq.
...
- **Dardha et al.**: Mungo/StMungo: session types to Java typestate. [PDF](https://www.dcs.gla.ac.uk/~ornela/publications/KDPG17.pdf)

/* Generated by ion-compiler from examples/showcase.ion. Do not edit.
...
static ION_MAYBE_UNUSED Status Status_Ok_new(int value) {
    Status result = { .tag = 0, .data = { .variant_0 = { .value = value } } };
    return result;
}

static ION_MAYBE_UNUSED Status Status_Err_new(int code) {
...
static ION_MAYBE_UNUSED Option_int Option_int_Some_new(int arg0) {
    Option_int result = { .tag = 0, .data = { .variant_0 = { .arg0 = arg0 } } };
    return result;
}

static ION_MAYBE_UNUSED Option_int Option_int_None_new() {
...
static ION_MAYBE_UNUSED Result_int_int Result_int_int_Ok_new(int arg0) {
    Result_int_int result = { .tag = 0, .data = { .variant_0 = { .arg0 = arg0 } } };
    return result;
}

static ION_MAYBE_UNUSED Result_int_int Result_int_int_Err_new(int arg0) {
...
Point create_point(int ION_MAYBE_UNUSED x, int ION_MAYBE_UNUSED y);
...
int main(void);
int get_first_int(Pair_int ION_MAYBE_UNUSED pair);
int add(int ION_MAYBE_UNUSED x, int ION_MAYBE_UNUSED y) {
    int ret_val = 0;
    ret_val = (x + y);
    goto epilogue;

...
static ION_MAYBE_UNUSED ReadResult ReadResult_Ok_new(ion_string_t* arg0) {
    ReadResult result = { .tag = 0, .data = { .variant_0 = { .arg0 = arg0 } } };
    return result;
}

static ION_MAYBE_UNUSED ReadResult ReadResult_Err_new(int arg0) {
...
TextCounts summarize_text(ion_string_t* ION_MAYBE_UNUSED text) {
    ...
    int words = 0;
    int in_word = 0;
    ion_string_t* __for_container_371 = text;
    (void)__for_container_371;
    int __for_i_371 = 0;
    (void)__for_i_371;
    while (__for_i_371 < ((__for_container_371) ? (int)((__for_container_371)->len) : 0)) {
        uint8_t ch = ({ int __ion_idx_0 = __for_i_371; (__ion_idx_0 >= 0 && __ion_idx_0 < (int)(__for_container_371->len)) ? __for_container_371->data[__ion_idx_0] : (ion_panic("String index out of bounds"), (uint8_t)0); });
        if (ch == 10) {
            lines = (lines + 1);
        }
        ...
        goto __for_step_371;
        __for_step_371:
        __for_i_371 = (__for_i_371 + 1);
    }
    ret_val = (TextCounts){.lines = lines, .words = words};
    if (__for_container_371) { ion_string_free(__for_container_371); }
    goto epilogue;
epilogue:
        return ret_val;
}

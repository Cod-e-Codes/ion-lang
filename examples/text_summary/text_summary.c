/* Generated by ion-compiler from text_summary.ion. Do not edit.
...
ion_string_t* fmt_int_to_string(int n) {
    ...
    int i = (len - 1);
    while (i >= 0) {
        uint8_t ch = ({ int __ion_idx_1 = i; (__ion_idx_1 >= 0 && __ion_idx_1 < 12) ? buf[__ion_idx_1] : (ion_panic("Array index out of bounds"), buf[0]); });
        if (ch == 48) {

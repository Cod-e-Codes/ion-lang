...
- **Tests**: `lexer_keywords_are_completed_and_highlighted` checks that lexer keywords are offered as completions and appear in the grammar.
- **Docs**: The adding-features skill, the LSP skill, and bug hotspots name the lexer `KEYWORDS` table, `EXTRA_COMPLETION_WORDS`, and `walk_referenced_expr`. Spec, ABI, tests, and examples are unchanged.
